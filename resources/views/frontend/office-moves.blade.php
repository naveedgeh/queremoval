...
<section id="page-title" class="page-title-mini">
    ...
    <div class="container clearfix">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Office Moves</li>
        </ol>
    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <h2 class="display-4 font-weight-bold">Office Moves</h2>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mt-4 mt-lg-0">
                    <img src="images/office2.jpg" alt="Image">
                </div>
                <div class="col-lg-6">
                    <div class="badge badge-pill badge-default">Que Removals</div>
                    <h2 class="display-4 font-weight-bold">Office Moves</h2>
