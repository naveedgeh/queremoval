<div class="main-box">
    <div class="mx-van-box collapsible">
     ...
     <div class="content">
        ...
        <label>
            <input id="driver19" data-v="No I will do it myself. Selfload" type="radio" name="driver">
             No I will do it myself. Selfload
        </label>
        <label>
         <input id="driver20" data-v="Driver help. I will help the driver with heavy item(s)" type="radio" name="driver">
         Driver help. I will help the driver with heavy item(s)
       </label>
       <label>
        <input id="driver21" data-v="2 Men Team. I don’t need to lift a finger" type="radio" name="driver">
        2 Men Team. I don’t need to lift a finger
      </label>
      <label>
        <input id="driver22" data-v=" 3 Men Team. I am the boss, bring me the red carpet" type="radio" name="driver">
  ...
  @push('javascript')
   ...
   $(document).ready(function(){
      ...
      $("#driver21").click(function(){
        ...
        $("#price6").html(`£ ${final<price?price+10:final}`);
        $("#bprice6").val(final);
      });
