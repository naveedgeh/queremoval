{{-- <div class="main-box">
    <div class="mx-van-box collapsible">
     ...
     <div class="content">
        ...
        <label>
            <input id="driver3" checked data-v="No I will do it myself. Selfload" value="No I will do it myself. Selfload" type="radio" name="driver_a">
             No I will do it myself. Selfload
        </label>
        <label>
         <input id="driver4" data-v="Driver help. I will help the driver with heavy item(s)" type="radio" name="driver_a">
         Driver help. I will help the driver with heavy item(s)
       </label>
       <label>
        <input id="driver5" data-v="2 Men Team. I don’t need to lift a finger" type="radio" name="driver_a">
        2 Men Team. I don’t need to lift a finger
      </label>
      <label>
        <input id="driver6" data-v="3 Men Team. I am the boss, bring me the red carpet" type="radio" name="driver_a">
  ...
  @push('javascript')
   ...
   $(document).ready(function(){
      ...
      $("#driver4").click(function(){
        let v=$(this).data('v');
        var final=final=price?price+{{$meddriverhelpprice}}:final;
        $("#price2").html(`£ ${final}`);
        $("#bprice2").val(final);
        $("#extrahelp1").val(v);
      });
      $("#driver5").click(function(){
        let v=$(this).data('v');
        let ppp={{$medtwomenprice}};
        var final=final=price?price+ppp:final;
        $("#price2").html(`£ ${final<price?price+ppp:final}`);
        $("#bprice2").val(final);
        $("#extrahelp1").val(v);
      });
      $("#driver6").click(function(){
        let v=$(this).data('v');
        var final=final=price?price+{{$medthremenprice}}:final;
        $("#price2").html(`£ ${final}`);
        $("#bprice2").val(final);
        $("#extrahelp1").val(v);
      });
